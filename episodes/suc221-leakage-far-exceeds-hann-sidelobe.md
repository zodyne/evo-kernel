---
id: suc221-leakage-far-exceeds-hann-sidelobe
type: episode
status: candidate
...
triggers:
  - "SUC221 分析 bin0 平坦泄漏渗入 bin3 的机理"
...
superseded_by: null
schema_version: 1
related: [episode-suc221-uneven-array-doa]
---

SUC221 实验 B（exp_b_leakage.py）实测：bin0→bin3 的泄漏污染**远超 Hann 窗副瓣理论预测**，泄漏不能按"纯 DC 音 + Hann 副瓣衰减"建模。

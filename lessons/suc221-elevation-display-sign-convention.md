---
id: suc221-elevation-display-sign-convention
type: lesson
status: candidate
...
triggers:
  - "对比 SUC221 robust 链俯仰估计与真值/参考实现"
...
superseded_by: null
schema_version: 1
related: [episode-suc221-uneven-array-doa, dual-impl-cross-check-tolerance-grid-anchored]
---

SUC221 robust 链俯仰角有**显示符号约定**（`rx_pair_doa.py:86` 的 `ROBUST_EL_DISPLAY_SIGN = -1`，对应 core 参考链 `--elevation-display-sign` 默认 -1）。不核对就直接与真值比较，会算出假误差。

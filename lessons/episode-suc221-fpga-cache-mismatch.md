---
id: episode-suc221-fpga-cache-mismatch
name: SUC221 测角算法与 FPGA 结果不一致排查
type: episode
status: candidate
scope: [debugging, hardware-software-integration]
domains: [suc221, radar, fpga]
triggers:
  - FPGA
  - 测角算法
  - 结果不一致
...
- 原 OpenClaw 知识库：`vault/10-Projects-Active/SUC221/SUC221_算法与软件推进会议纪要.md`
- 迁移时间：2026-07-25

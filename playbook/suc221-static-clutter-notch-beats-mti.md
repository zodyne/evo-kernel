---
id: suc221-static-clutter-notch-beats-mti
type: bullet
status: validated
scope: project:suc221
domain: radar-signal
tags: [suc221, mti, cfar, 静杂波, 零多普勒陷波, 实测]
triggers:
  - "静止地面雷达数据做静杂波抑制方案选型"
...
superseded_by: null
schema_version: 1
related: [suc221-mti-mean-vs-frame-cancellation, playbook-suc221-cfar-point-cloud-filtering]
---
静止雷达场景下零多普勒陷波远优于 MTI 帧间复对消（SUC221 静止地面数据实测）。
